...
void Distribution::SetTrunc(double xmin, double xmax)
{
    ...
    else
    {
        ...
        {
            case Cauchy:
                cdf0 = boost::math::cdf(boost::math::cauchy_distribution<double>(a, b), q0);
                cdf1 = boost::math::cdf(boost::math::cauchy_distribution<double>(a, b), q1);
                break;
            case LogNormal:
                cdf0 = boost::math::cdf(boost::math::lognormal_distribution<double>(a, b), q0);
                cdf1 = boost::math::cdf(boost::math::lognormal_distribution<double>(a, b), q1);
                break;
            case Normal:
                cdf0 = boost::math::cdf(boost::math::normal_distribution<double>(a, b), q0);
                cdf1 = boost::math::cdf(boost::math::normal_distribution<double>(a, b), q1);
                break;
            case Uniform:
                cdf0 = boost::math::cdf(boost::math::uniform_distribution<double>(a, b), q0);
                cdf1 = boost::math::cdf(boost::math::uniform_distribution<double>(a, b), q1);
                break;
            case Beta:
                cdf0 = boost::math::cdf(boost::math::beta_distribution<double>(a, b), q0);
                cdf1 = boost::math::cdf(boost::math::beta_distribution<double>(a, b), q1);
                break;
            case Exponential:
                cdf0 = boost::math::cdf(boost::math::exponential_distribution<double>(a), q0);
                cdf1 = boost::math::cdf(boost::math::exponential_distribution<double>(a), q1);
                break;
            case Gamma:
                cdf0 = boost::math::cdf(boost::math::gamma_distribution<double>(a, b), q0);
                cdf1 = boost::math::cdf(boost::math::gamma_distribution<double>(a, b), q1);
                break;
            case Rounded:
...
double Distribution::RoundedUniformCDF(double min, double max, double shoulder, double x)
{
    ...
    if (x < min)        return boost::math::cdf(boost::math::normal_distribution<double>(min, sd), x) * shoulder;
    else if (x < max)   return shoulder / 2 + (x - min) / (max - min) * (1 - shoulder);
    else                return boost::math::cdf(boost::math::normal_distribution<double>(max, sd), x) * shoulder + (1 - shoulder);
}
